...
[Ekleme Linkim](https://discord.com/api/oauth2/authorize?client_id=12345678&permissions=8&scope=bot)

[Destek Sunucum](https://discord.gg/frayzz)

[Oy Vermeyi Unutma](ekle)
==================================
**`)
  .setThumbnail(message.author.avatarURL())
...
<a:BeratBulbulkrmzyldz:786584135762051103> » [${prefix}ekle](https://discord.gg/frayzz) Link Eklemenize Yarar
<a:BeratBulbulkrmzyldz:786584135762051103> » [${prefix}erişim-kontrol](https://discord.gg/frayzz) Erişim Kontrol
<a:BeratBulbulkrmzyldz:786584135762051103> » [${prefix}linkler](https://discord.gg/frayzz) Liklerinizi Gösterir
`)
  .addField('**Hakkında**',`
...
==================================
> <a:BeratBulbulonline:786584064702414879> » [Destek Server](https://discord.gg/frayzz)
> <a:BeratBulbulonline:786584064702414879> » [Eklemek İçin](https://discord.com/oauth2/authorize?client_id=12345&permissions=8&scope=bot)`)
.setThumbnail('https://media.discordapp.net/attachments/748599239671677079/793498323402620938/no.1_reiss_adammsnnn.gif')
...
client.on("message", async message => {
  ...
  if(!["ortak id","kendi id"].includes(message.author.id)) return;
